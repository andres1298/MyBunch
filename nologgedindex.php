...
<html>
    ...
    file_put_contents('SQL/txt/cedula.txt', json_encode(0));
    ?>
    
    <head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>Tienda MyBunch</title>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
                            ...
                            <li><a href="signup.php">Crea una cuenta!</a></li>
						</ul>
					</div>
				</div>
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/bunchs/bunch6.jpg);" data-stellar-background-ratio="0.5">
                            ...
                            $ibunch = 0;
                             ...
                             while($filabunch = sqlsrv_fetch_array($ejecutarbunch)){
								...
								<li class="text-center">
                                    ...
                                    <div>
                                       <a class="btn btn-primary" href="login.php">Agregar</a>
						          </div>
								</li>
								<?php } ?>
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image: url(images/img_bg_3.jpg);">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2>Disfruta de los mejores Bunchs<br><span> Pay Now and <br> Get <span class="percent">35%</span> Discount</span></h2>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="#" class="btn btn-default btn-lg">Disfruta de nuestros Bunchs!</a></p>
				</div>
			</div>
		</div>
	</div>
