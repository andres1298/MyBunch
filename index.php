...
<html>
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image: url(images/img_bg_3.jpg);">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2>Disfruta de lo mejor<br><span> al mejor precio <br> y consigue <span class="percent">Puntos</span> por cada Bunch que adquieres</span></h2>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="carrito.php" class="btn btn-default btn-lg">Disfruta de nuestros Bunchs!</a></p>
				</div>
			</div>
		</div>
	</div>
